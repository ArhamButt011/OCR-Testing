  ...
  const pdfFiles = selectedRows
    .map((rowId) => {
      ...
      if (
        ...
        return {
          file_url_or_path: `https://9syrgizq8iyc8f-8080.proxy.runpod.net/api/access-file?filename=${encodeURIComponent(
            fileName
          )}`,
          _id: job?._id,
        };
                      ...
                      {selectedRows
                        ...
                        .map((rowId) => {
                          ...
                          const pdfFilename = job.pdfUrl
                            ...
                            : "";
                          const progressKey = `https://9syrgizq8iyc8f-8080.proxy.runpod.net/api/access-file?filename=${pdfFilename}`;
