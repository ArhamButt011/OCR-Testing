        ...
        <div className="flex">
          ...
          <div className="ml-3 flex-1">
            ...
            <div className="mt-2 text-sm text-primary space-y-1">
              <div className="font-mono text-xs bg-white rounded px-2 py-1">
                stamp.total_received → OCR_RCVQTY (integer)
              </div>
              <div className="font-mono text-xs bg-white rounded px-2 py-1">
                bill_of_lading.bill_no → OCR_BOLNO (string)
              </div>
              <div className="font-mono text-xs bg-white rounded px-2 py-1">
                stamp.pod_date → OCR_STMP_POD_DTT (date)
              </div>
              <div className="font-mono text-xs bg-white rounded px-2 py-1">
                stamp.damage → OCR_SYMT_DAMG (integer, default: 0)
              </div>
            </div>
          </div>
        </div>
